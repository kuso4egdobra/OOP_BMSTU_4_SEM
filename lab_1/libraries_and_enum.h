...
enum ACTIONS {INIT, MOVE, SKALE, TURN, SAVE_POINTS, IMPORT_DEFAULT_POINTS,
              IMPORT_POINTS_FROM_FILE, UPDATE_SCENE, DELETE_BACKGROUND};
enum ERRORS {OK, ERR_OPEN_FILE, SUCCES_TO_SAVE_POINTS, INPUT_DATA_ERROR_IN_FILE,
             INVALID_ENTRY_UI, SUCCES_TO_IMPORT_POINTS, ERROR_NOT_FOUND, ERROR_NEW_MEM};
